...
class VehicleController(Node):
    def __init__(self):
        ...
        self.plot_logger = CrossTrackPlotLogger(self, "third_order")
    ...
    def main_timer_callback(self):
        ...
        if self.have_goal_pose and self.have_vehicle_pose: #3rd Order Curve Controller
            p1_ratio = 0.25
            cross_track_error, heading_error, _ = get_cross_track_and_heading_error(
                self.closest_point,
